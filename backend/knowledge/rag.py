"""Inventory Intelligence RAG: grounded retrieval + LangChain generation.

This module is part of StockMind AI — the Inventory Intelligence Engine.
It ONLY handles inventory-related queries. Raw CSV rows are never embedded.
Instead, Inventory Knowledge Documents are generated by the ML pipeline and embedded.
"""
...
- Reorder quantities, EOQ, ROP, safety stock
- Forecast demand and its impact on inventory
- Supplier performance, lead times, and delay risks
- Working capital tied up in inventory
- Inventory turnover and slow-moving products
